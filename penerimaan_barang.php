    ...
    <div class="card-body">
        <form action="penerimaan_barang.php" method="post" class="needs-validation" novalidate>
            ...
            <div id="new_product_section" style="display: none;">
                <div class="form-row">
                    <div class="form-group col-md-4"><label for="new_sku">SKU Baru (Contoh: P000)<span class="text-danger">*</span></label><input type="text" class="form-control" id="new_sku" name="new_sku"></div>
